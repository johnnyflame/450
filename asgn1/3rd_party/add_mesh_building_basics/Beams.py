...
def addBeamObj(sRef,context):
    ...
    beamObj.data.materials.append(uMatRGBSet("Beam_mat",sRef.beamRGB,matMod=True))
...
class addBeam(bpy.types.Operator):
    ...
    beamRGB=FloatVectorProperty(min=0,max=1,default=(0.8,0.8,0.8),subtype='COLOR',size=3)
